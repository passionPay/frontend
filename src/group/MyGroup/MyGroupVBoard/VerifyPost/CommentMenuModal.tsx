...
type CommentMenuModalPropsType = {
...
const CommentMenuModal = ({ modalVisible, setModalVisible, editParams, postId, isAuthor, }: CommentMenuModalPropsType) => {
...
CommentMenuModal.defaultProps = defaultProps
