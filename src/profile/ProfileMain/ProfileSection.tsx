                ...
                <View style={{flex:1.5,justifyContent:'center'}}>
                    <View style={{flexDirection:'row',flex:1,justifyContent:'space-between',marginHorizontal:width*0.9*0.66*0,marginRight:width*0.9*0.66*0.07}}>
                        <TouchableOpacity style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            <Text style={{fontSize:20}}>{profileData.followingCount}</Text>
                            <Text style={{marginTop:5, fontSize:12}}>팔로잉</Text>
                            
                        </TouchableOpacity>
                        <TouchableOpacity style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            <Text style={{fontSize:20}}>{profileData.followerCount}</Text>
                    ...
                    <View style={{flexDirection:'row',flex:1,justifyContent:'space-between',marginHorizontal:width*0.9*0.66*0,marginRight:width*0.9*0.66*0.07}}>
                        ...
                        <TouchableOpacity style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            <Text style={{fontSize:20}}>{profileData.postCount}</Text>
                            <Text style={{marginTop:5, fontSize:12}}>내가 쓴 글</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                            <Text style={{fontSize:20}}>{profileData.commentPostCount}</Text>
