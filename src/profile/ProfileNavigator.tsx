...
import SetProfileImage from './Setting/ProfileSettingSection/SetProfileImage'
...
import SetUserStatus from './Setting/ProfileSettingSection/SetUserStatus'
...
export default function ProfileNavigator() {
    ...
    return <Stack.Navigator screenOptions={{ headerShown: false }} >
        ...
        <Stack.Screen name='SetProfileImage' component={SetProfileImage}/>
        <Stack.Screen name='SetResolution' component={SetResolution}/>

        <Stack.Screen name='SetPassword' component={SetPassword}/>
        <Stack.Screen name='SetEmail' component={SetEmail}/>
        <Stack.Screen name='SetUserStatus' component = {SetUserStatus}/>
