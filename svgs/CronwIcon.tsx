...
const CronwIcon = ({width,height,color})=>{
    const CrownSvg = () => <SvgXml xml={crown} width={'150%'} height={'150%'} fill={'gold'} />
    return <CrownSvg/>
}

export default CronwIcon